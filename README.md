...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/whisper.cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/whisper.cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=25735&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/whisper.cpp-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>osx_arm64</td>
...
pixi add whisper.cpp
# for installing globally
pixi global install whisper.cpp
```
...
It is possible to list all of the versions of `whisper.cpp` available on your platform:
...
```
pixi search whisper.cpp --channel conda-forge
```
